...
template<class Type>
void fvFieldDecomposer::setFvsPatchFieldValues
(
    PtrList<fvsPatchField<Type> >& patchFields,
    const Field<Type>& faceField,
    label patchI
) const
{
    patchFields[patchI] ==
...
void fvFieldDecomposer::setFvsPatchFieldValues
(
    PtrList<fvsPatchField<scalar> >& patchFields,
    const Field<scalar>& faceField,
    label patchI
) const
{
    patchFields[patchI] ==
...
) const
{
    ...
    forAll (boundaryAddressing_, patchI)
    {
        ...
        else
        {
            ...
            setFvsPatchFieldValues(patchFields, allFaceField, patchI);
        }
    }
