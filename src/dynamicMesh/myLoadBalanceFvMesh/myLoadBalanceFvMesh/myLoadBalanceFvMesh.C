...
namespace Foam
{
    defineTypeNameAndDebug(myLoadBalanceFvMesh, 0);
    addToRunTimeSelectionTable(dynamicFvMesh, myLoadBalanceFvMesh, IOobject);
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

bool Foam::myLoadBalanceFvMesh::checkLoadBalance
(
...
Foam::myLoadBalanceFvMesh::myLoadBalanceFvMesh(const IOobject& io)
:
    ...
    )
{
    ...
    if (imbalanceTrigger_ < SMALL || imbalanceTrigger_ > 1)
    {
        ...
        (
            "myLoadBalanceFvMesh::"
            "myLoadBalanceFvMesh(const IOobject& io)"
...
Foam::myLoadBalanceFvMesh::~myLoadBalanceFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::myLoadBalanceFvMesh::update()
{
    if (Pstream::parRun())
    {
