...
Foam::DispersionIncomprRASModel<CloudType>::DispersionIncomprRASModel
(
...
:
    ...
    (
        ...
        lookupObject<incompressible::RASModel>
        (
            "RASProperties"
        )
    ),
...
template<class CloudType>
void Foam::DispersionIncomprRASModel<CloudType>::cacheFields(const bool store)
{
    if (store)
    {
